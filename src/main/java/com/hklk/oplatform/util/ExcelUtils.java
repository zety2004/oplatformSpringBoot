...
public class ExcelUtils {
     ...
     * @throws IOException
     */
    public static void exportExcel(ServletOutputStream out, String fileExtension, String[] columnHeaders,
     ...
     * @throws IOException
     */
    public static void exportExcel(ServletOutputStream out, String fileExtension, Collection<?> collection,
...
/*        style.setFillPattern(HSSFCellStyle.SOLID_FOREGROUND);
     ...
     * @throws IOException
     */
    private static void writeFile(ServletOutputStream out, Workbook workbook)
            throws IOException {
        workbook.write(out);
    }
